...
def upgrade():
    ...
    op.drop_constraint(
        "project_teams_team_id_fkey", "project_teams", type_="foreignkey"
    )

    # Drop FK from project_notes.team_id -> groups.id
    op.drop_constraint(
        "project_notes_team_id_fkey", "project_notes", type_="foreignkey"
    )

    # Drop FK from project_team_externals.group_id -> groups.id
    op.drop_constraint(
        "project_team_externals_group_id_fkey",
