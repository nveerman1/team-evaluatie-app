...
type LinkStudentToCourseModalProps = {
  isOpen: boolean;
  onClose: () => void;
  studentName: string;
...
export default function LinkStudentToCourseModal({
  isOpen,
  onClose,
  studentName,
  currentCourseName,
  onLink,
}: LinkStudentToCourseModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || "Kon leerling niet koppelen aan vak");
    } finally {
      setLoading(false);
    }
  };
