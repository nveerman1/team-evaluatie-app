...
class TestAuthorizationChecks:
    ...
    def test_students_can_only_query_own_data_in_get_my_attendance(self):
        ...
        assert (
            "AttendanceEvent.user_id == current_user.id" in source
            or "user_id=current_user.id" in source
        )
...
class TestProjectAccessEndpoint:
    ...
    def test_get_my_projects_filters_by_student_enrollment(self):
        ...
        assert (
            "student_id == current_user.id" in source
            or "student_id=current_user.id" in source
        )
