...
class TestWebhookURLValidation:
    ...
    def test_valid_https_public_url(self):
        ...
        with patch(
            "app.api.v1.utils.url_validation.socket.getaddrinfo",
            return_value=[
    ...
    def test_dns_resolution_failure(self):
        ...
        with patch(
            "app.api.v1.utils.url_validation.socket.gethostbyname",
...
class TestWebhookServiceSSRFProtection:
    ...
    def test_webhook_service_validates_url(self):
        ...
        with patch(
            ...
            success, error = WebhookService.send_webhook(
                url="https://localhost/webhook", payload={"test": "data"}
            )
    ...
    def test_webhook_service_allows_valid_url(self):
        ...
        with patch(
            ...
            with patch(
                "app.infra.services.webhook_service.requests.post",
