...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_project_plan_project_id", "project_plans", ["project_id"], unique=False
    )
    op.create_index(
        "ix_project_plan_school", "project_plans", ["school_id"], unique=False
    )
    op.create_index(op.f("ix_project_plans_id"), "project_plans", ["id"], unique=False)
    op.create_index(
        op.f("ix_project_plans_school_id"), "project_plans", ["school_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_plan_id"], ["project_plans.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "project_plan_id", "project_team_id", name="uq_project_plan_team"
        ),
    )
    op.create_index(
        "ix_ppt_project_plan", "project_plan_teams", ["project_plan_id"], unique=False
    )
    op.create_index(
        "ix_ppt_project_team", "project_plan_teams", ["project_team_id"], unique=False
    )
    op.create_index("ix_ppt_status", "project_plan_teams", ["status"], unique=False)
    op.create_index(
        op.f("ix_project_plan_teams_id"), "project_plan_teams", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_project_plan_teams_school_id"),
        "project_plan_teams",
        ["school_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_plan_team_id"], ["project_plan_teams.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        op.f("ix_project_plan_sections_id"),
        "project_plan_sections",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_plan_sections_school_id"),
        "project_plan_sections",
        ["school_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_project_plan_sections_school_id"), table_name="project_plan_sections"
    )
    op.drop_index(
        op.f("ix_project_plan_sections_id"), table_name="project_plan_sections"
    )
    ...
    op.drop_index(
        op.f("ix_project_plan_teams_school_id"), table_name="project_plan_teams"
    )
