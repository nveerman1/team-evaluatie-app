...
def upgrade():
    ...
    op.drop_constraint(
        "uq_project_score_per_criterion", "project_assessment_scores", type_="unique"
    )
...
def downgrade():
    ...
    op.create_unique_constraint(
        "uq_project_score_per_criterion",
        "project_assessment_scores",
