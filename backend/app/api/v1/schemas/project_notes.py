...
TODO: Uncomment and implement these schemas once the database models are created.
"""
...
#     course_name: Optional[str]  # Joined from Course table
#     class_name: Optional[str]
#     description: Optional[str]
#     evaluation_id: Optional[int]
#     created_by: int
#     created_by_name: Optional[str]  # Joined from User table
#     created_at: datetime
#     updated_at: datetime
...
#     note_type: str
#     team_id: Optional[int]
#     team_name: Optional[str]  # Joined
#     student_id: Optional[int]
#     student_name: Optional[str]  # Joined
#     text: str
#     tags: List[str]
#     omza_category: Optional[str]
#     learning_objective_id: Optional[int]
#     learning_objective_title: Optional[str]  # Joined
#     is_competency_evidence: bool
#     is_portfolio_evidence: bool
#     metadata: Dict[str, Any]
#     created_by: int
#     created_by_name: Optional[str]  # Joined
#     created_at: datetime
#     updated_at: datetime
# 
#     class Config:
