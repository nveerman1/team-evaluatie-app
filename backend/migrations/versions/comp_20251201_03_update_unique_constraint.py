...
def upgrade() -> None:
    ...
    op.drop_constraint("uq_competency_name_per_school", "competencies", type_="unique")
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "uq_competency_name_per_school_teacher", "competencies", type_="unique"
    )

    # Restore the old constraint
    op.create_unique_constraint(
        "uq_competency_name_per_school", "competencies", ["school_id", "name"]
    )
