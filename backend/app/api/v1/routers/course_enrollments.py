...
def list_course_enrollments(
    ...
    # Build query
    query = db.query(CourseEnrollment).join(Course).filter(Course.school_id == school_id)
    ...
    for enrollment in enrollments:
        ...
        enrollment_dict["course_name"] = enrollment.course.name if enrollment.course else None
