...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["competency_categories.id"],
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["learning_objective_id"], ["learning_objectives.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["school_id"], ["schools.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_skill_training_category",
        "skill_trainings",
        ["competency_category_id"],
        unique=False,
    )
    op.create_index(
        "ix_skill_training_school", "skill_trainings", ["school_id"], unique=False
    )
    op.create_index(
        "ix_skill_training_school_active",
        "skill_trainings",
        ["school_id", "is_active"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["training_id"], ["skill_trainings.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["updated_by_user_id"], ["users.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "student_id",
    ...
    op.create_index(
        "ix_skill_progress_course",
        "skill_training_progress",
        ["course_id"],
        unique=False,
    )
    op.create_index(
        "ix_skill_progress_course_training",
        "skill_training_progress",
        ["course_id", "training_id"],
        unique=False,
    )
    op.create_index(
        "ix_skill_progress_student",
        "skill_training_progress",
        ["student_id"],
        unique=False,
    )
    op.create_index(
        "ix_skill_progress_training",
        "skill_training_progress",
        ["training_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_skill_progress_course_training", table_name="skill_training_progress"
    )
