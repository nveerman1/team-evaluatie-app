...
export function SkillTrainingTab() {
  ...
  const [detailsTraining, setDetailsTraining] =
    useState<StudentTrainingItem | null>(null);
    ...
    return trainings.filter((training) => {
      ...
      if (searchQuery) {
        ...
        if (
          ...
          !training.training.competency_category_name
            ?.toLowerCase()
            .includes(query)
        ) {
          return false;
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Werk aan je vaardigheden en volg je voortgang.
            </p>
          </div>
            ...
            <table className="min-w-[900px] w-full">
              ...
              <tbody>
                {filteredTrainings.map((item) => {
                  const canChangeStatus = STUDENT_ALLOWED_STATUSES.includes(
                    item.status,
                  );
                  return (
                    <tr
          ...
          <div className="space-y-4">
            <div>
              <div className="text-lg font-semibold text-slate-900">
                {detailsTraining.training.title}
              </div>
              <div className="text-sm text-slate-600">
                {detailsTraining.training.competency_category_name}
              </div>
            </div>
            ...
            <div>
              ...
              <button
                ...
                disabled={
                  detailsTraining.status === "completed" ||
                  detailsTraining.status === "mastered"
                }
                className={cn(
                  "transition-opacity",
                  detailsTraining.status === "completed" ||
