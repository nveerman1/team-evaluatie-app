...
import { ClientCreate } from "@/dtos/client.dto";
...
export function ClientFormModal({ isOpen, onClose, onSuccess }: ClientFormModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || "Fout bij opslaan van opdrachtgever");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/20"
                  placeholder="Bijv. Vastgoed, Zorg, Technologie"
                />
              </div>
            </div>
