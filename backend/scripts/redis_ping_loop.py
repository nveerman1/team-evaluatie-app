...
def main():
    ...
    logger.info(f"Connection settings: socket_timeout=600s, health_check_interval=30s, retry_on_timeout=True")
    logger.info("")
    ...
    logger.info(f"Successful pings:  {success_count} ({success_count/ping_count*100:.1f}%)")
