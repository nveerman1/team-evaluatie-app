  ...
  useEffect(() => {
    async function fetchReflections() {
      try {
        ...
        const peerReflections: CombinedReflection[] =
          peerResponse.reflectionItems
        ...
        const competencyReflections =
          await competencyMonitorService.getReflections({
            courseId,
          });
        ...
        const combined = [...peerReflections, ...compReflections].sort(
          (a, b) => {
