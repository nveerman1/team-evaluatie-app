      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200">
            ...
            <p
              className={`text-3xl font-bold ${getScoreColor(student.currentOverallScore)} bg-transparent`}
            >
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200">
            ...
            <div
              className={`flex items-center gap-1 text-xl font-bold ${getTrendColor(student.trendDelta)}`}
            >
              <span>
                  ...
                  <div className="flex-1">
                    <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${((scan.overallScore || 0) / 5) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
