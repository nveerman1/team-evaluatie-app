...
def students(school):
    ...
    return [
        User(id=100, school_id=school.id, email="s1@test.com", name="Student 1", role="student"),
        User(id=101, school_id=school.id, email="s2@test.com", name="Student 2", role="student"),
        User(id=102, school_id=school.id, email="s3@test.com", name="Student 3", role="student"),
        User(id=103, school_id=school.id, email="s4@test.com", name="Student 4", role="student"),
    ]
...
class TestCloneClasses:
    ...
    def test_clone_all_mapped_classes(self, mock_db, school, target_year, source_classes):
...
class TestCopyStudentMemberships:
    ...
    def test_copy_all_students(self, mock_db, source_year, target_year):
        ...
        mock_db.query.return_value.filter.return_value.all.return_value = source_memberships
        ...
        students_moved, skipped = AcademicYearTransitionService.copy_student_memberships(
            db=mock_db,
    ...
    def test_skip_unmapped_class(self, mock_db, source_year, target_year):
        ...
        source_memberships = [
            ...
            StudentClassMembership(
                id=2, student_id=101, class_id=99, academic_year_id=source_year.id  # Unmapped
            ),
        ]
...
class TestCopyCoursesAndEnrollments:
    ...
    def test_skip_duplicate_enrollment(self, mock_db, school, source_year, target_year):
        ...
        source_courses = [
            Course(id=1, school_id=school.id, academic_year_id=source_year.id, name="Math"),
        ]
